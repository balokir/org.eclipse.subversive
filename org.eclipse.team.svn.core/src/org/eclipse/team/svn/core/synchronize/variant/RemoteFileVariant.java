...
public class RemoteFileVariant extends RemoteResourceVariant {
	...
	protected void fetchContents(IProgressMonitor monitor) throws TeamException {
		if ((!this.local.isCopied() && this.local.getRevision() == SVNRevision.INVALID_REVISION_NUMBER) || 
				(IStateFilter.SF_DELETED.accept(this.local) || local.getStatus() == IStateFilter.ST_TREE_CONFLICTING && !IStateFilter.SF_TREE_CONFLICTING_REPOSITORY_EXIST.accept(this.local)) &&
